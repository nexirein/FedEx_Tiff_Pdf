...
export default function UbondConsol() {
  ...
  const generatePreview = async () => {
    ...
    try {
      ...
      setErrorMessage(`Could not generate preview: ${err.message}`)
    }
  }
          ...
          <div className="p-8">
            ...
            <div className="mb-8 flex justify-center">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-indigo-700 transition-all shadow-lg hover:shadow-xl"
              >
            ...
            <div className="mb-8">
              ...
              >
                <svg className={`w-4 h-4 transition-transform ${showFormat ? 'rotate-90' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                </svg>
                {showFormat ? 'Hide' : 'Show'} expected Excel format
              </button>
              {showFormat && (
